...
import com.AirPollutionRobot.thingspeakandroid.ThingSpeakChannel;
import com.AirPollutionRobot.thingspeakandroid.ThingSpeakLineChart;
...
public class DemoActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tsChannel = new ThingSpeakChannel(9);//Server頻道設定
